...
In addition, we provide a well-organized code framework that supports single-modal and multi-modal data input processing, allows sample splitting by ratio or fixed quantity, and offers validation and testing performance evaluation as well as visualization functions.
You only need to modify the network structure to run your own experiments directly.
